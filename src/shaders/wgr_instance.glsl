/* The frame's per-placement records, shared by the shading pass (wgr_model.glsl) and the
 * shadow depth pass (wgr_depth.glsl). One record a placement, written by src/wgr_model.c
...
@block wgr_instance_data
/* Per-instance data for the frame (src/wgr_model.c): one record a placement, eight
