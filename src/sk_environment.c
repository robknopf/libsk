...
static sk_module_t sk_environment_module = {.name = "environment", .order = 40, .init = sk_environment_init, .deinit = sk_environment_deinit, .end_frame = sk_environment_end_frame};
SK_MODULE(sk_environment_module)
