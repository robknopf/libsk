...
/* Record a 3D sprite for the current pass, seen by the active camera. depth_write:
 * whether it writes depth (direct draws do; a scene's sorted transparent pass
