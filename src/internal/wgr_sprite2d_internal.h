#ifndef WGRI_INTERNAL_SPRITE2D_H
#define WGRI_INTERNAL_SPRITE2D_H
...
void wgri_sprite2d_corners(const wgri_sprite2d_placement_t *placement, float out[8]);
...
bool wgri_sprite2d_screen_to_unit(const wgri_sprite2d_placement_t *placement, float screen_x, float screen_y,
                                float *u, float *v);

#endif // WGRI_INTERNAL_SPRITE2D_H
