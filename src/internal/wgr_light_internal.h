#ifndef WGRI_INTERNAL_LIGHT_H
#define WGRI_INTERNAL_LIGHT_H
...
#define WGRI_MAX_SCENE_LIGHTS 64 /* enabled lights considered per scene draw */
#define WGRI_MAX_LIGHT_ENVS 16   /* lighting environments (scene draws) per frame */
...
typedef struct {
    ...
    int shadow_lights[WGRI_MAX_SHADOW_LIGHTS];
    int shadow_count;
} wgri_light_env_t;
...
float       wgri_light_shadow_get_distance(wgr_handle_t light);
int         wgri_light_shadow_get_map_size(wgr_handle_t light);
float       wgri_light_shadow_get_strength(wgr_handle_t light);
wgr_color_t wgri_light_shadow_get_color(wgr_handle_t light);
float       wgri_light_shadow_get_bias_constant(wgr_handle_t light);
float       wgri_light_shadow_get_bias_slope(wgr_handle_t light);
