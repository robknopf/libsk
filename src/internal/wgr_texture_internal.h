#ifndef WGRI_INTERNAL_TEXTURE_H
#define WGRI_INTERNAL_TEXTURE_H
...
typedef struct wgri_texture_pixels wgri_texture_pixels_t;

/* Decode a PNG or JPEG file's bytes. NULL on failure (wgri_texture_pixels_error
...
/* The target the GPU is drawing into (0 = the screen). wgri_texture_get_binding
