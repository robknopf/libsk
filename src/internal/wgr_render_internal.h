#ifndef WGRI_INTERNAL_RENDER_H
#define WGRI_INTERNAL_RENDER_H
...
#define WGRI_GFX_BUFFER_POOL_SIZE 4096 /* two per glTF primitive */
#define WGRI_GFX_IMAGE_POOL_SIZE 2048  /* textures, render targets, environments */
#define WGRI_GFX_VIEW_POOL_SIZE 4096
...
/* What wgr_render reaches through optional modules (internal/wgri_module.h): each module
...
extern wgri_render_hooks_t wgri_render_hooks;
...
typedef void (*wgri_render_callback_fn)(int arg);
 ...
 * when the list is full. wgri_render_sprites_open: whether that batch's command is
 ...
 * wgri_render_is_3d_transparent: which one is on (sprites follow it). */
