...
typedef enum {
    WGR_TONEMAP_NONE = 0,    /* clip */
    WGR_TONEMAP_NEUTRAL = 1, /* Khronos PBR Neutral: colors kept until highlights roll off (default) */
    WGR_TONEMAP_ACES = 2,    /* filmic: more contrast, highlights shift toward white */
} wgr_tonemap_t;
