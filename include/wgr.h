...
#include "wgr_asset.h"    // IWYU pragma: keep
#include "wgr_audio.h"    // IWYU pragma: keep
#include "wgr_camera3d.h" // IWYU pragma: keep
...
#include "wgr_logger.h"  // IWYU pragma: keep
#include "wgr_material.h" // IWYU pragma: keep
#include "wgr_model.h"   // IWYU pragma: keep
#include "wgr_pick.h"    // IWYU pragma: keep
#include "wgr_render.h"  // IWYU pragma: keep
#include "wgr_scene.h"   // IWYU pragma: keep
#include "wgr_shader.h"  // IWYU pragma: keep
#include "wgr_shape2d.h" // IWYU pragma: keep
#include "wgr_shape3d.h" // IWYU pragma: keep
#include "wgr_sound.h"   // IWYU pragma: keep
#include "wgr_emitter2d.h" // IWYU pragma: keep
#include "wgr_emitter3d.h" // IWYU pragma: keep
#include "wgr_sprite2d.h" // IWYU pragma: keep
#include "wgr_sprite3d.h" // IWYU pragma: keep
#include "wgr_text.h"    // IWYU pragma: keep
#include "wgr_text2d.h"  // IWYU pragma: keep
#include "wgr_text3d.h"  // IWYU pragma: keep
#include "wgr_texture.h" // IWYU pragma: keep
#include "wgr_types.h"   // IWYU pragma: keep
#include "wgr_version.h" // IWYU pragma: keep
#include "wgr_window.h"  // IWYU pragma: keep

#ifdef __cplusplus
extern "C" {
#endif

typedef enum wgr_init_result_t {
    WGR_INIT_OK = 0,
    WGR_INIT_ERR_UNKNOWN = -1,
    WGR_INIT_ERR_ALREADY_INITIALIZED = -2,
    WGR_INIT_ERR_WINDOW = -5,
} wgr_init_result_t;

/* Loop model: sokol_app owns the frame loop, so libwgrender is callback-driven.
 * Configure with wgr_init_values(), register callbacks, then call wgr_run(). On
 ...
 *          Never draw here.
 *   frame  once per rendered frame (wgr_set_frame): variable update and drawing.
...
typedef void (*wgr_tick_fn)(float dt, void *user_data);
typedef void (*wgr_frame_fn)(float dt, float tick_fraction, void *user_data);
typedef void (*wgr_lifecycle_fn)(void *user_data);
