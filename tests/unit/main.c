 ...
 *
 * From the repo root, where the assets are examples/assets:
 *
 *   out/linux/headless/unit_tests          run every test
 *   out/linux/headless/unit_tests pick_    run tests whose name starts with "pick_"
 *
...
static const test_case_t TESTS[] = {
    ...
    {"shader_sprites", test_shader_sprites},
    ...
    {"shadow_instancing", test_shadow_instancing},
    ...
    {"model_instance_record", test_model_instance_record},
    {"model_instancing", test_model_instancing},
    {"animation_sampling", test_animation_sampling},
    {"sprite_pick_alpha", test_sprite_pick_alpha},
    {"text2d_state", test_text2d_state},
    {"scene_layer_order", test_scene_layer_order},
    {"render_command_merging", test_render_command_merging},
    ...
    {"text3d_state", test_text3d_state},
    {"sprite3d_state", test_sprite3d_state},
