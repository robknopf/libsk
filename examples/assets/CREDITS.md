...
- `textures/blobshadow.png`: drawn in Krita; the same shadow is under the model in
  `woman_casual.glb`, whose colours are baked into a palette texture there so it has
  one body material.
