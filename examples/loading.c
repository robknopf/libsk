...
static struct {
    ...
    wgr_handle_t gumshoe, sphere, material;
    wgr_handle_t group;
...
static void release_all(void)
{
    ...
    wgr_model_set_mesh(g.gumshoe, 0);
...
static void create_all(void)
{
    ...
    wgr_model_set_mesh(g.gumshoe, g.resources[2]);
...
static void init(void *user_data)
{
    ...
    wgr_model_set_transform(g.gumshoe, -1.2f, 0, 0, 0, 0.4f, 0, 0.5f, 0.5f, 0.5f);
